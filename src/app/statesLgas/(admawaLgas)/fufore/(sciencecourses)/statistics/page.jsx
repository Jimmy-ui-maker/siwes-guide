      ...
      <div class="container" data-aos="fade-up">
        <div class="section-title ">
          <h2 className=" text-center fw-bold  text-uppercase">
            Statistical Science Siwes Organazation List
          </h2>
          <p className=" text-center ">Fufore LGA, Adamawa State, Nigeria.</p>
        </div>
        <hr />
        <div className=" d-flex justify-content-center my-4">
          <Link className=" btn w-25 border-white fw-bold" href={"/createData"}>
