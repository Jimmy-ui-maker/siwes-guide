...
export default function OyoForm() {
  const [fname, setFname] = useState("");
  const [orgName, setOrgName] = useState("");
  const [state, setState] = useState("Oyo");
  const [lgas, setLgas] = useState("Afijio");
  ...
  async function handleSubmit(e) {
    ...
    const response = await fetch("/api/oyo", {
      method: "POST",
      headers: {
                    ...
                    <div className="col-lg-4">
                      ...
                      <div className="mb-3">
                        ...
                        >
                          ...
                          <option value="Attba">Attba</option>
                          ...
                          <option value="Ifedapo">Ifedapo</option>
                          <option value="Ifeloju">Ifeloju</option>
                          <option value="Irepo">Irepo</option>
                          <option value="Iseyin">Iseyin</option>
                          <option value="Itesiwaju">Itesiwaju</option>
                          <option value="Iwwajowa">Iwwajowa</option>
                          <option value="Iwajowa Olorunshogo">Iwajowa Olorunshogo</option>
                          <option value="Kajola">Kajola</option>
                          <option value="Lagule">Lagule</option>
                          <option value="gbamosho North">gbamosho North</option>
                          <option value="gbamosho South">gbamosho South</option>
