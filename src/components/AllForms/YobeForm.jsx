...
export default function YobeForm() {
  const [fname, setFname] = useState("");
  const [orgName, setOrgName] = useState("");
  const [state, setState] = useState("Yobe");
  const [lgas, setLgas] = useState("Borsari");
  ...
  async function handleSubmit(e) {
    ...
    const response = await fetch("/api/yobe", {
      method: "POST",
      headers: {
                    ...
                    <div className="col-lg-4">
                      ...
                      <div className="mb-3">
                        ...
                        >
                          ...
                          <option value="Nagere">Nagere</option>
