...
export default function GombeForm() {
  const [fname, setFname] = useState("");
  const [orgName, setOrgName] = useState("");
  const [state, setState] = useState("Gombe");
  const [lgas, setLgas] = useState("Akko");
  ...
  async function handleSubmit(e) {
    ...
    const response = await fetch("/api/gombe", {
      method: "POST",
      headers: {
                    ...
                    <div className="col-lg-4">
                      ...
                      <div className="mb-3">
                        ...
                        >
                          ...
                          <option value="Dunakaye">Dunakaye</option>
