...
export default function BauchiForm() {
  const [fname, setFname] = useState("");
  const [orgName, setOrgName] = useState("");
  const [state, setState] = useState("Bauchi");
  const [lgas, setLgas] = useState("Alkaleri");
  ...
  async function handleSubmit(e) {
    ...
    const response = await fetch("/api/bauchi", {
      method: "POST",
      headers: {
                    ...
                    <div className="col-lg-4">
                      ...
                      <div className="mb-3">
                        ...
                        >
                          ...
                          <option value="Bauchi Bogoro">Bauchi Bogoro</option>
                          <option value="Dambam">Dambam</option>
                          <option value="Barazo">Barazo</option>
                          ...
                          <option value="Missau">Missau</option>
