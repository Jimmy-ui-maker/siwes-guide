...
export default function KanoForm() {
  const [fname, setFname] = useState("");
  const [orgName, setOrgName] = useState("");
  const [state, setState] = useState("Kano");
  const [lgas, setLgas] = useState("Ajingi");
  ...
  async function handleSubmit(e) {
    ...
    const response = await fetch("/api/kano", {
      method: "POST",
      headers: {
                    ...
                    <div className="col-lg-4">
                      ...
                      <div className="mb-3">
                        ...
                        >
                          ...
                          <option value="Kumbsto">Kumbsto</option>
                          <option value="Kunch">Kunch</option>
                          <option value="Kura">Kura</option>
                          <option value="Maidobi">Maidobi</option>
                          <option value="Makoda">Makoda</option>
                          <option value="Minjibir Nasarawa">Minjibir Nasarawa</option>
