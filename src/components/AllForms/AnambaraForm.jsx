...
export default function AnambaraForm() {
  const [fname, setFname] = useState("");
  const [orgName, setOrgName] = useState("");
  const [state, setState] = useState("Anambara");
  const [lgas, setLgas] = useState("Anambara East");
  ...
  async function handleSubmit(e) {
    ...
    const response = await fetch("/api/anambara", {
      method: "POST",
      headers: {
                  ...
                  <div className="row">
                    <div className="col-lg-4">
                      ...
                      <div className="mb-3">
                        ...
                        >
                          <option value="Anambara East">Anambara East</option>
                          <option value="Anambara West">Anambara West</option>
                          <option value="Ayemelum">Ayemelum</option>
                          <option value="Ogbaru">Ogbaru</option>
                          <option value="Onoitsha North">Onoitsha North</option>
                          <option value="Onoitsha South">Onoitsha South</option>
                          <option value="Oyi">Oyi</option>
                          <option value="Akwa North">Akwa North</option>
                          <option value="Akwa South">Akwa South</option>
