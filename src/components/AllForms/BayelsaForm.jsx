...
export default function BayelsaForm() {
  const [fname, setFname] = useState("");
  const [orgName, setOrgName] = useState("");
  const [state, setState] = useState("Bayelsa");
  const [lgas, setLgas] = useState("Brass");
  ...
  async function handleSubmit(e) {
    ...
    const response = await fetch("/api/bayelsa", {
      method: "POST",
      headers: {
                    ...
                    <div className="col-lg-4">
                      ...
                      <div className="mb-3">
                        ...
                        >
                          ...
                          <option value="South Ijaw">South Ijaw</option>
