...
export default function ZamfaraForm() {
  const [fname, setFname] = useState("");
  const [orgName, setOrgName] = useState("");
  const [state, setState] = useState("Zamfara");
  const [lgas, setLgas] = useState("Ankah");
  ...
  async function handleSubmit(e) {
    ...
    const response = await fetch("/api/zamfara", {
      method: "POST",
      headers: {
                  ...
                  <div className="row">
                    <div className="col-lg-4">
                      ...
                      <div className="mb-3">
                        ...
                        >
                          <option value="Ankah">Ankah</option>
                          ...
                          <option value="Bugudu">Bugudu</option>
