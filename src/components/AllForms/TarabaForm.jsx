...
export default function TarabaForm() {
  const [fname, setFname] = useState("");
  const [orgName, setOrgName] = useState("");
  const [state, setState] = useState("Taraba");
  const [lgas, setLgas] = useState("Ardo-Kola");
  ...
  async function handleSubmit(e) {
    ...
    const response = await fetch("/api/taraba", {
      method: "POST",
      headers: {
                    ...
                    <div className="col-lg-4">
                      ...
                      <div className="mb-3">
                        ...
                        >
                          ...
                          <option value="K/Lamido">K/Lamido</option>
