...
export default function OndoForm() {
  const [fname, setFname] = useState("");
  const [orgName, setOrgName] = useState("");
  const [state, setState] = useState("Ondo");
  const [lgas, setLgas] = useState("Akoko North");
  ...
  async function handleSubmit(e) {
    ...
    const response = await fetch("/api/ondo", {
      method: "POST",
      headers: {
                  ...
                  <div className="row">
                    <div className="col-lg-4">
                      ...
                      <div className="mb-3">
                        ...
                        >
                          <option value="Akoko North">Akoko North</option>
                          ...
                          <option value="Akoko South">Akoko South</option>
                          ...
                          <option value="Ilaje Oke-Igbo">Ilaje Oke-Igbo</option>
