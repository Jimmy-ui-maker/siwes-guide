...
export default function SokotoForm() {
  const [fname, setFname] = useState("");
  const [orgName, setOrgName] = useState("");
  const [state, setState] = useState("Sokoto");
  const [lgas, setLgas] = useState("Binji");
  ...
  async function handleSubmit(e) {
    ...
    const response = await fetch("/api/sokoto", {
      method: "POST",
      headers: {
                    ...
                    <div className="col-lg-4">
                      ...
                      <div className="mb-3">
                        ...
                        >
                          ...
                          <option value="Garonyo">Garonyo</option>
